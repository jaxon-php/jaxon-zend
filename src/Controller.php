...
class Controller
{
    ...
    // Application data
    // These data will be set by the Zend Jaxon library when registering the controller
    public $view = null;
    public $zfJaxon = null; // The Zend Jaxon module
    ...
    public function controller($name)
    {
        ...
        return (($this->zfJaxon) ? $this->zfJaxon->controller($name) : null);
    }
}
